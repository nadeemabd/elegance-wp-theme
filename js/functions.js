...
(function ($) {
    ...
    (function () {
        ...
        menuToggle.on('click.elegance', function () {
    ...
    (function () {
        ...
        function toggleFocusClassTouchScreen() {
            if (window.innerWidth >= 900) {
                ...
                siteNavigation.find('.menu-item-has-children > a').on('touchstart.elegance', function (e) {
                ...
                siteNavigation.find('.menu-item-has-children > a').unbind('touchstart.elegance');
            }
        }

        if ('ontouchstart' in window) {
            $(window).on('resize.elegance', toggleFocusClassTouchScreen);
            toggleFocusClassTouchScreen();
        }

        siteNavigation.find('a').on('focus.elegance blur.elegance', function () {
    ...
    $(document).ready(function () {
        ...
        $(window)
            .on('load.elegance', onResizeARIA)
            .on('resize.elegance', function () {
